  ...
  execute: async (client, message, args) => {
   ...
   let commandscount = "214";
      ...
      const embed = new MessageEmbed()
        ...
        .addField("**:level_slider: Level Commands**", "`rank`\n\n**Economy**\n`addmoney`, `balance`, `beg`, `bet`, `buy`, `daily`, `deposit`, `monthly`, `pay`, `profile`, `roulette`, `weekly`, `withdraw`, `work`\n\n** Logs**\n`logs-ticket`, `set-logs`, `remove-logs`\n\n**:tada:Giveaway Commands**\n`edit`, `list`, `end`, `reroll`, `start`,`create`, `cancel`\n\n**MUSIC**\n`24/7`, `bassboost`, `dc`, `connect`, `lyrics`, `np`, `pause`, `play`, `queue`, `resume`, `shuffle`, `skip`, `stop`, `volume`\n\n**Report/Suggest**\n`suggest`, `bug-report`\n\n**:partying_face: Welcome and leave Commands**\n`leave`, `set-welcome`, `set-leave`, `welcome`")





        .addField("**:ticket: Ticket Commands**", "`add`, `close`, `delete`, `new`, `open`, `remove`, `setup`\n\n**:performing_arts:Reaction Role Commands**\n`reaction-role`, `reaction-role-remove`\n\n**:video_game: Games Commands**\n`csgo`, `poke`, `slots`, `tictactoe`\n\n**:frame_photo: Images/Fun Commands**\n`3000yr`, `approved`, `batslap`, `beautiful`, `brazzers`, `burn`, `cat`, `challenger`, `cuddle`, `dict`, `distort`, `dog`, `ddungeon`, `facechange`, `fire`, `flatearth`, `foxgirl`, `gay`, `hug`, `kiss`, `love`, `magik`, `meme`, `qrcode`, `randomav`, `rip`, `scary`, `slap`, `triggered`, `tickle`, `tweet`, `vs`, `wanted`")


        .addField("**:hammer: Moderation Commands :hammer:**", "`announce`, `ban`, `color`, `hide`, `kick`, `lock`, `maintainence`, `nuke`, `prune`, `purge`, `say`, `sendembed`, `serverlock`, `serverunlock`, `set`, `slowmode`, `stealemoji`, `unban`, `unhide`, `unlock`, `vcid`, `voicedeafen`, `voicekick`, `voicemove`, `voicemute`, `voiceundeaf`, `voiceunmute`, `warn`, `warns`\n\n**:robot:Chatbot**\n`remove-channel`, `set-channel`\n\n**Utility**\n`avatar`, `covid`, `id`, `members`, `roleid`, `github`, `servericon`, `serverinfo`, `time`, `info`, `weather`")


        .addField('Important Links ','**[Invite Me](https://discord.com/api/oauth2/authorize?client_id=948600024806338560&permissions=8&scope=bot%20applications.commands)** **• [Discord Server](https://discord.gg/xxVp58DwgQ)**')
